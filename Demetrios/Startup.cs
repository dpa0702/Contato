...
namespace Demetrios
{
    public class Startup
    {
        ...
        {
            services.AddTransient<IContatoPostService, ContatoPostService>();
        }

        private static void ConfigureRepositories(IServiceCollection services)
        {
            services.AddSingleton<IContatoPostRepository, ContatoPostRepository>();
        }
        ...
        private static void ConfigureEntityFramework(IServiceCollection services)
        {
            ...
            services.AddDbContext<ContatoPostDatabaseContext>(options =>
